...
$email_title   = isset( $title ) ? $title : __( 'New Form Submission', 'wbizmo-form-builder' );
					...
					<tr>
						<td style="padding:28px;">
							...
							<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:22px;background:#f8f6f0;border-radius:18px;padding:16px;">
								...
								<tr>
									<td style="font-size:14px;color:rgba(14,34,56,0.65);padding:6px 0;"><?php esc_html_e( 'Submission ID', 'wbizmo-form-builder' ); ?></td>
									<td align="right" style="font-size:14px;font-weight:700;color:#0E2238;padding:6px 0;">
								...
								<?php if ( $page_url ) : ?>
									<tr>
										<td style="font-size:14px;color:rgba(14,34,56,0.65);padding:6px 0;"><?php esc_html_e( 'Page', 'wbizmo-form-builder' ); ?></td>
										<td align="right" style="font-size:14px;font-weight:700;color:#0E2238;padding:6px 0;">
							...
							<h2 style="font-size:18px;margin:0 0 14px;color:#0E2238;"><?php esc_html_e( 'Submitted Details', 'wbizmo-form-builder' ); ?></h2>
